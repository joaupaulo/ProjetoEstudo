...
namespace NewLife.Controllers
{
    ...
    {
        private readonly ProjetoContexto _context;

        public EnderecoesController(ProjetoContexto context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,CEP,Complemento,Rua,Numero,Cidade,Estado,ClienteId,ProdutosId")] Endereco endereco)
        {
